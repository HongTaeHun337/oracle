...
insert into tblSubject values(3, '컴파일');

insert into tblRegistration values(1,1,100);
insert into tblRegistration values(1,2,100);
insert into tblRegistration values(1,3,100);
insert into tblRegistration values(2,1,100);
insert into tblRegistration values(2,2,100);
insert into tblRegistration values(2,3,100);
insert into tblRegistration values(3,1,100);
insert into tblRegistration values(3,2,100);
insert into tblRegistration values(3,3,100);
...
create table tblExtra(
    ...
    subject_seq number, --refrences tblRegistration(student_seq)
