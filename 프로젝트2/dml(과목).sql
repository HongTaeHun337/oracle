...
INSERT INTO SUBJECT VALUES (subject_Seq.NEXTVAL, '파이썬 입문', '공통');
INSERT INTO SUBJECT VALUES (subject_Seq.NEXTVAL, 'C언어 프로그래밍', '공통');
INSERT INTO SUBJECT VALUES (subject_Seq.NEXTVAL, '데이터베이스 개론', '공통');
INSERT INTO SUBJECT VALUES (subject_Seq.NEXTVAL, 'SQL 활용', '공통');
INSERT INTO SUBJECT VALUES (subject_Seq.NEXTVAL, '자료구조', '공통');
INSERT INTO SUBJECT VALUES (subject_Seq.NEXTVAL, '알고리즘', '공통');
INSERT INTO SUBJECT VALUES (subject_Seq.NEXTVAL, '운영체제', '공통');
INSERT INTO SUBJECT VALUES (subject_Seq.NEXTVAL, '컴퓨터 구조', '공통');
INSERT INTO SUBJECT VALUES (subject_Seq.NEXTVAL, '네트워크 기초', '공통');
INSERT INTO SUBJECT VALUES (subject_Seq.NEXTVAL, '소프트웨어 공학', '공통');
INSERT INTO SUBJECT VALUES (subject_Seq.NEXTVAL, '객체지향 설계', '공통');
INSERT INTO SUBJECT VALUES (subject_Seq.NEXTVAL, 'Git 버전 관리', '공통');
INSERT INTO SUBJECT VALUES (subject_Seq.NEXTVAL, '리눅스 시스템', '공통');
INSERT INTO SUBJECT VALUES (subject_Seq.NEXTVAL, '직업 윤리', '공통');
-----------------------------------------------------------------------------------------------------개별
...
INSERT INTO SUBJECT VALUES (subject_Seq.NEXTVAL, '스프링 부트', '개별');
