...
/*
    ...
    1. 숫자형
        ...
        a. number
            ...
            - 123456789012345678901234567890123456780000000000
            - 1~22byte
    ...
    2. 문자형 > varchar2
        ...
        a. char
            ...
            - char(n): 최대 n자리 문자열, n(바이트)
                - 최소 크기: 1바이트
                - 최대 크기: 2000바이트
            - 데이터 삽입 후 > 남은 공간을 공백으로 채운다. > 항상 n자리로 매운다(강박증)
            - 고정 문자열 > 전화번호, 우편번호, 이름
        
        b. nchar
            - n: national > 오라클 인코딩(UTF-8) 상관없이 해당 컬럼을 UTF-16으로 동작
...
insert into tblType (num) values (3.54); -- 4 반올림함
insert into tblType (num) values (999);
insert into tblType (num) values (-999);
insert into tblType (num) values (999.99); -- X
insert into tblType (num) values (999.39); -- O
insert into tblType (num) values (1000);
insert into tblType (num) values (-1000);
insert into tblType (num) values (12345678901234567890123456789012345678);
insert into tblType (num) values (123456789012345678901234567890123456789012345678);
insert into tblType (num) values (-99.99);
insert into tblType (num) values (99.99); 
insert into tblType (num) values (99.99999999); -- X
insert into tblType (num) values (99.9099999); -- O 
...
select * from tblType; -- 테이블 모든 데이터를 가져와라
